...
[repository settings](https://github.com/mountyli/mountyli.github.io/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
